import {
    ...
    removeTeacher,searchTeacher,
    listTeachers,getTeacherById,
    getTeacherByUserId
} from '../services/teacherService.js';


 // Récupère la fiche professeur de l'utilisateur actuellement connecté
...
const getProfesseurParId = (req, res) => {
 ...
 // Recherche des professeurs par mot-clé (nom ou matière)
...
const chercherProfesseur = (req, res) => {
 ...
 // Ajoute un nouveau professeur (crée l'utilisateur associé + le professeur)
